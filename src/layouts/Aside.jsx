...
import { AccessTime, Delete, Diversity2, PeopleAlt, Star, Storage } from '@mui/icons-material'

export default function Aside() {
    return (
        <aside className="hidden md:flex md:flex-col shadow-lg max-w-6xl w-72 h-full max-h-screen">
